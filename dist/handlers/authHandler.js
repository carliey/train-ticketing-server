    ...
    return __generator(this, function (_e) {
        switch (_e.label) {
            ...
            case 2:
                user = _e.sent();
                console.log(user);
                return [4 /*yield*/, (0, auth_1.createJWT)(user)];
            case 3:
                token = _e.sent();
                res.json({ token: token, user: user, message: "user created successfully" });
                return [3 /*break*/, 5];
            case 4:
                error_1 = _e.sent();
...
var signin = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var user, isValid, token, userWithoutPassword, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                token = _a.sent();
                userWithoutPassword = (0, exclude_1.exclude)(user, ["password"]);
